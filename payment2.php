...
<?php
$prodamt =$_POST['txtamt'];
 $card_no = $_POST['txt1'];
 $cvvno = $_POST['txt2'];
 $exdate = $_POST['txtexpiry'];
 //echo "$exdate";
 //$exyear = $_POST['payementidyear'];
 //echo "$exyear";
 $date=date('d.m.y h:i:s');
//$mixture = $exdate.$exyear;
//echo "$mixture";
$con = mysqli_connect("localhost", "root", "", "home");
	
	$sql = "INSERT INTO  payment(cust_fid,total_amount,date,card_no,cvvno,Expired_date) VALUES ('$customerchiid','$prodamt','$date','$card_no','$cvvno','$exdate')";
	
	if(mysqli_query($con, $sql))
	{
    echo "<h1><center> THANK YOU VISIT AGAIN </center></h1>";
	...
	$changestatus = "purchase";
	$sql2 ="UPDATE cart SET status='$changestatus' where cust_Fid='$customerchiid'";
	
	if(mysqli_query($con, $sql2))
	{
		echo "<h1><center> Update Succesfully </center></h1>";
	}
	else
	{
