<html>
    <head>
        ...
        {  
            ...
            var url="updatevehicleajax.php?val="+v;  
    ...
    <body>
        <center>
            <form name="myform" action="updatevehicle2.php" method="post">
...
<table align="center" cellpadding="3">
   	<th colspan="2">
	<font color="RED" face="Arno Pro Caption" size="+7"> Update Vehicle Info </font>
        </th>
            <tr>
               <td>Vehicle Id :</td>
