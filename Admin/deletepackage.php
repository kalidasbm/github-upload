<html>
    <head>
        ...
        {  
            ...
            var url="deletepackageajax.php?val="+v;  
    ...
    <body>
        <center>
            <form name="myform" action="deletepackage2.php" method="post">
...
<table align="center" cellpadding="3">
   	<th colspan="2">
	<font color="RED" face="Arno Pro Caption" size="+7"> Delete Product </font>
        </th>
            <tr>
               <td>Product Id :</td>
