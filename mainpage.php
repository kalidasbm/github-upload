...
<!---728x90--->
			<div class="agile_top_brands_grids">
				...
				$sql="SELECT * FROM product where p_id= 7";
  ...
  {
  $ProductID=$userrow['p_id'];
			//session_start();
  			//$_SESSION["firstimage"] = "$ProductID";
  $ProductName=$userrow['p_name'];
  $photo=$userrow['pictures'];
  $product_amount=$userrow['p_amount'];
?>
	
	<table>
  <tr>
  <td><?php echo $ProductName; ?></td>
 <td> <img width="300" height="250" src="<?php echo "Photos/".$photo; ?>"> </img></td>

 </table>
 
 <div class="snipcart-details top_brand_home_details">
											<form action="cartrecords.php" method="POST">
												<fieldset>
													
													<input type="hidden" name="amount" value="<?php echo $product_amount; ?>" />
													<input type="hidden" name="tempid" value="<?php echo $ProductID; ?>" />
  ...
  $ProductID=$userrow['p_id'];
			//session_start();
  			//$_SESSION["secondimage"] = "$ProductID";
  $ProductName=$userrow['p_name'];
  $photo=$userrow['pictures'];
  $product_amount=$userrow['p_amount'];
?>
	<form method="temp.php" method="GET">
	<table>
  <tr>
  <td><?php echo $ProductName; ?></td>
 <td><img width="300" height="250" src="<?php echo "Photos/".$photo; ?>"> </img></td>
...
?>
 ...
 <div class="snipcart-details top_brand_home_details">
				...
				$sql="SELECT * FROM product where p_id= 4";
  ...
  $ProductID=$userrow['p_id'];
			//session_start();
  			//$_SESSION["fourthimage"] = "$ProductID";
  $ProductName=$userrow['p_name'];
  $photo=$userrow['pictures'];
  $product_amount=$userrow['p_amount'];
?>
