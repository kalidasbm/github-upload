...
<?php	$con = mysqli_connect("localhost", "root", "", "home");
	...
	$sql2="select * from customerr where cust_id='$customerchiid'";
	$result2=mysqli_query($con,$sql2);
	if($cust=mysqli_fetch_assoc($result2))
	{
		$emailid = $cust['c_email'];
		//echo "$emailid";
	}
 $semail = $_GET['cname'];
 		//echo "$semail";
	...
	//$user_id ="100"; 
	$sql = "insert into feedback(user_fid,email_id,message)  VALUES ('$customerchiid','$emailid','$contentmess')";
	
	//$result=mysqli_query($con,$sql);
				
	if($result=mysqli_query($con,$sql))
	{
    echo "<h1> Thanks for Your valuable feedback </h1>";
